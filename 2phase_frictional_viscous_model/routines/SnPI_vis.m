function [S,PI] = SnPI_vis(a)
% The calculation of interior Eshelby tensors for isotropic viscouse 
% material using the elastic Eshelby tensors by setting the Poisson's ratio
% to 0.5.
